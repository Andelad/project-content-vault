...
**For entity definitions and what things ARE, see [Domain Logic.md](../Domain%20Logic.md).**
...
> - UI Rules (docs/components/) - Timeline View (how this data is displayed in different views)
...
**Timeline View** (see UI Rules in docs/components/):
```
...
**View Layer:** (See UI Rules in docs/components/)
