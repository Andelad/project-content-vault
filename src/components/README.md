...
- **Architecture Guide**: `/docs/core/Architecture Guide.md` - Services architecture and patterns
- **Business Logic Reference**: `/docs/core/Business Logic.md` - Domain rules
