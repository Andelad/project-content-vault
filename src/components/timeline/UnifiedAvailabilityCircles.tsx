...
export const UnifiedAvailabilityCircles = memo(function UnifiedAvailabilityCircles({ 
  ...
  // Match TimelineView's column width: 153px for weeks, 52px for days
    ...
    <TooltipProvider delayDuration={100}>
      <div className="h-full relative flex items-center">
        ...
        {dates.map((date: Date, dateIndex: number) => {
          ...
          const columnElement = (
            <div
              className={`flex justify-center items-center relative ${context === 'planner' ? 'border-r border-gray-200' : ''}`}
              style={columnStyle}
            ...
            >
              ...
              <div 
                className={`absolute inset-0 bg-black transition-opacity duration-200 pointer-events-none ${
                  hoveredColumnIndex === dateIndex ? 'opacity-[0.04]' : 'opacity-0'
                }`}
              />
