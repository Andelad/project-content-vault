...
import { ProjectMapper, PhaseMapper, CalendarEventMapper, ClientMapper } from '@/infrastructure/mappers';
import type { Project, PhaseDTO, CalendarEvent, Client } from '@/shared/types/core';
