...
import { ProjectPhaseSection, ProjectInsightsSection, ProjectNotesSection } from '@/presentation/components/features/project';
...
import { calculateAutoEstimateHoursPerDay, calculateTotalWorkingDays } from '@/domain/rules/projects/ProjectBudget';
import { expandHolidayDates } from '@/domain/rules/holidays/HolidayCalculations';
import { clearTimelineCache } from '@/domain/rules/availability/EventWorkHourIntegration';
import { ProjectOrchestrator } from '@/application/orchestrators/ProjectOrchestrator';
import { formatDuration, normalizeToMidnight } from '@/presentation/utils/dateCalculations';;
import type { ProjectEvent } from '@/domain/rules/projects/ProjectMetrics';
import { formatDate, formatDateForInput } from '@/presentation/utils/dateFormatUtils';
import { useToast } from '@/presentation/hooks/ui/use-toast';
import { StandardModal } from './StandardModal';
import { OKLCH_PROJECT_COLORS, PROJECT_ICONS } from '@/presentation/constants';
