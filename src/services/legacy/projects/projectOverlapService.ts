 ...
 *
 * Handles business logic for project conflicts during drag operations.
 * Moved from lib/projectOverlapUtils.ts to follow architectural patterns.
 *
 * 🚨 ARCHITECTURAL RULE: Services calculate, Components render
 */
 ...
 * Enhanced version for real-time conflict detection
 */
 ...
 * Enhanced version with multiple resolution strategies
 */
