...
import { 
  calculateDurationHours as coreDurationHours, 
...
export function calculateDurationHours(startTime: Date, endTime: Date): number {
  return coreDurationHours(startTime, endTime);
}
...
export function calculateDurationMinutes(startTime: Date, endTime: Date): number {
  return coreDurationMinutes(startTime, endTime);
}
...
export function formatDurationPreview(startTime: Date, endTime: Date): string {
  const durationMinutes = coreDurationMinutes(startTime, endTime);
  return coreFormatDurationFromMinutes(durationMinutes);
}
...
export function formatTimeForValidation(date: Date): string {
  return coreFormatTimeForValidation(date);
}
