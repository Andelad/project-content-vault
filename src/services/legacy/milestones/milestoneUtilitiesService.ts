...
import { calculateAutoEstimateWorkingDays } from '@/services';
import { calculateMilestoneTimeDistribution as unifiedCalculateMilestoneTimeDistribution } from '@/services/unified/UnifiedProjectService';
...
/**
 * @deprecated Use UnifiedMilestoneService.calculateMilestoneDateRange
 */
export function calculateMilestoneDateRange(
  ...
  console.warn('calculateMilestoneDateRange is deprecated. Use UnifiedMilestoneService.calculateMilestoneDateRange instead.');
  return UnifiedMilestoneService.calculateMilestoneDateRange({
    projectStartDate,
    projectEndDate,
    existingMilestones,
    currentMilestone
...
/**
 * @deprecated Use UnifiedMilestoneService.calculateDefaultMilestoneDate
 */
export function calculateDefaultMilestoneDate(
  ...
  console.warn('calculateDefaultMilestoneDate is deprecated. Use UnifiedMilestoneService.calculateDefaultMilestoneDate instead.');
...
/**
 * @deprecated Use UnifiedMilestoneService.generateOrdinalNumber
 */
export function getOrdinalNumber(num: number): string {
  console.warn('getOrdinalNumber is deprecated. Use UnifiedMilestoneService.generateOrdinalNumber instead.');
  return UnifiedMilestoneService.generateOrdinalNumber(num);
}

// Legacy milestone service is now deprecated - use unified services instead
