/**
 * Calendar Positioning Service
 * 
 * Handles time-based positioning calculations for calendar grid elements,
 * including time slot snapping, position-to-time conversion, and duration
 * formatting for draggable work hour components.
 */
